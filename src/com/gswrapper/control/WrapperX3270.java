...
public class WrapperX3270 implements Wrapper3270 {
	...
	private static final String MENSAJE_NUEVA_CONEXION = "Se ha establecido una nueva conexi�n a %s : %d";
	...
	private static final String MENSAJE_DESCONEXION = "Se ha perdido la conexi�n con el servidor";
